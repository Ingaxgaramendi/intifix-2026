...
public class PaymentConfiguration {
    ...
    public PaymentProvider primaryMercadoPagoProvider(com.intifix.modules.payments.provider.MercadoPagoProvider mercadoPagoProvider) {
    ...
    public PaymentProvider primaryStripeProvider(com.intifix.modules.payments.provider.StripeProvider stripeProvider) {
    ...
    public PaymentProvider primaryCulqiProvider(com.intifix.modules.payments.provider.CulqiProvider culqiProvider) {
