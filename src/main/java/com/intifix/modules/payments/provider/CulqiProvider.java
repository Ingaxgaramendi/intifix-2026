...
public class CulqiProvider implements PaymentProvider {
    ...
    private static final String PROVIDER_NAME = "Culqi";
    ...
    public PaymentResult procesarPago(PaymentRequest request) {
        log.info("Procesando pago con Culqi para servicio: {}", request.idServicio());
        
        try {
            String transactionId = "CULQI-" + UUID.randomUUID().toString();
            ...
            log.error("Error procesando pago con Culqi", e);
            return new PaymentResult(
                    false,
                    null,
    ...
    public PaymentResult confirmarPago(String transactionId) {
        log.info("Confirmando pago con Culqi: {}", transactionId);
    ...
    public PaymentResult reembolsarPago(String transactionId, String razon) {
        log.info("Reembolsando pago con Culqi: {}, razon: {}", transactionId, razon);
    ...
    public PaymentStatus consultarEstado(String transactionId) {
        log.info("Consultando estado de pago con Culqi: {}", transactionId);
